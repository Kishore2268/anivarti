  ...
  return (
    <div className="service-card bg-black p-4 rounded shadow flex flex-col py-28">
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        >
          ...
          <p className="text-sm md:text-md lg:text-lg tracking-[1px] text-gray-300 mb-4">
            Etsy is a global online marketplace for handmade, vintage items, and craft supplies. It is known for its unique products and strong community of sellers and buyers.
          </p>
          <p className="text-sm md:text-md lg:text-lg tracking-[1px] text-gray-300">
            Anivarti is dedicated to helping brands succeed on Etsy by providing expert consultancy and tailored support to enhance your online presence.
          </p>
        </motion.div>
      </div>
      ...
      <div className="service-list w-[95%] md:w-[85%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
        {[
          { title: "Etsy Seller Registration", desc: "We assist with the registration process to get you started on Etsy." },
          { title: "Etsy Product Listing", desc: "We list products to increase visibility and generate traffic on Etsy." },
          { title: "Etsy Advertising", desc: "Drive sales and boost visibility with targeted ads on Etsy's platform." },
          { title: "Payment Reconciliation", desc: "We ensure money leaving on account matches the amount spent." },
          { title: "Etsy SEO", desc: "Optimize product listings to improve rankings, visibility, and sales on Etsy." },
          { title: "Product Image Editing", desc: "Enhance your product photos with professional editing to boost appeal and sales." },
          { title: "Reviews Management", desc: "We manage all Etsy reviews of your products in the most effective way." },
          { title: "Etsy Brand Store Creation", desc: "Build a custom storefront on Etsy to showcase your brand and increase customer engagement." },
          { title: "Account Suspension", desc: "Our experts will help get your suspended Etsy account back to you." },
          { title: "Warehouse Services", desc: "Our Warehouse Service is an added advantage for your Etsy business." },
        ].map((service, index) => (
          <motion.div
            key={index}
            initial={{ opacity: 0, y: 50 }}
