  ...
  return (
    <div className="service-card bg-black p-4 rounded shadow flex flex-col py-28">
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        >
          <img src="/images/nykaa-logo.webp" alt="Nykaa Logo" className="sm:w-36 h-32 sm:mr-0 md:mr-6" />
        ...
        >
          ...
          <p className="text-sm md:text-md lg:text-lg tracking-[1px] text-gray-300 mb-4">
            Nykaa is a leading beauty and wellness e-commerce platform in India, offering a wide range of cosmetics, skincare, and personal care products. It is known for its quality and extensive product selection.
          </p>
          <p className="text-sm md:text-md lg:text-lg tracking-[1px] text-gray-300">
            Anivarti is dedicated to helping brands succeed on Nykaa by providing expert consultancy and tailored support to enhance your online presence.
          </p>
        </motion.div>
      </div>
      ...
      <div className="service-list w-[95%] md:w-[85%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
        {[
          { title: "Nykaa Seller Registration", desc: "We assist with the registration process to get you started on Nykaa." },
          { title: "Nykaa Product Listing", desc: "We list products to increase visibility and generate traffic on Nykaa." },
          { title: "Nykaa Advertising", desc: "Drive sales and boost visibility with targeted ads on Nykaa's platform." },
          { title: "Payment Reconciliation", desc: "We ensure money leaving on account matches the amount spent." },
          { title: "Nykaa SEO", desc: "Optimize product listings to improve rankings, visibility, and sales on Nykaa." },
          { title: "Product Image Editing", desc: "Enhance your product photos with professional editing to boost appeal and sales." },
          { title: "Reviews Management", desc: "We manage all Nykaa reviews of your products in the most effective way." },
          { title: "Nykaa Brand Store Creation", desc: "Build a custom storefront on Nykaa to showcase your brand and increase customer engagement." },
          { title: "Account Suspension", desc: "Our experts will help get your suspended Nykaa account back to you." },
          { title: "Warehouse Services", desc: "Our Warehouse Service is an added advantage for your Nykaa business." },
        ].map((service, index) => (
          <motion.div
            key={index}
            initial={{ opacity: 0, y: 50 }}
